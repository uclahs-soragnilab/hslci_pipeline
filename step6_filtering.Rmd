...
unlabeled_data_path <- "K:/tracked/2022_06_16_MCF7_test_BW_processed_stacks_UNet_Trackmate_PTLinux/condition-level_aggregate_data" # This must be the output path from step 5 ending with "/condition-level_aggregate_data"
```
