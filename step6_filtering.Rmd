...
unlabeled_data_path <- "H:/tracked/2022_08_14_SARC0139_BW_tracked/condition-level_aggregate_data" # This must be the output path from step 5 ending with "/condition-level_aggregate_data"
```
