...
unlabeled_data_path <- "K:/tracked/2022_06_16_MCF7_test_BW_processed_stacks_tracked/condition-level_aggregate_data" # This must be the output path from step 5 ending with "/condition-level_aggregate_data"
```
...
for (i in 1:length(combined.pathways)) {
    ...
    file.data <- read.csv(combined.pathways[i], header = FALSE);
